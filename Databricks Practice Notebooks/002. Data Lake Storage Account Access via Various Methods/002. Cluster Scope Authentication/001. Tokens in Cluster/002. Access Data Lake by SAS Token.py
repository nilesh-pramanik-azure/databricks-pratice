...
# MAGIC %md
# MAGIC #####Accessing Storage Account by SAS Token in the Cluster
# MAGIC * Get the SAS Token<br>
# MAGIC * Set the spark configuration in the Cluster Spark Configuration like below with **KEY VALUE** Pair<br>
# MAGIC <img src="/files/tables/Cluster_Scope___SAS_Token_Key.jpg" width="400" height="200" />
