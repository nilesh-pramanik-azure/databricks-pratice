...
# MAGIC %md
# MAGIC #####Accessing Storage Account by Storage Access Key in the Cluster using Secret Scope
...
# MAGIC <img src="/files/tables/Cluster_Scope___Storage_Access_Key_Secret_Scope.jpg" width="400" height="200" />
