...
# MAGIC %md
# MAGIC #####Accessing Storage Account by Service Principle in the Cluster using Secret Scope
# MAGIC * Get the Service Principle Tokens from Secret Scope<br>
# MAGIC * Set the spark configuration in the Cluster Spark Configuration like below with **KEY VALUE** Pair<br>
# MAGIC <img src="/files/tables/Cluster_Scope___Service_Principle_Secret_Scope.jpg" width="400" height="200" />
