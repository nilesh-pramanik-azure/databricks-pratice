...
df_races = spark.sql("""SELECT * FROM f1_processed.races""")

# COMMAND ----------

df_circuits = spark.sql("""SELECT * FROM f1_processed.circuits""")

# COMMAND ----------

df_drivers = spark.sql("""SELECT * FROM f1_processed.drivers""")

# COMMAND ----------

df_constructors = spark.sql("""SELECT * FROM f1_processed.constructors""")

# COMMAND ----------

df_results = spark.sql("""SELECT * FROM f1_processed.results""")
...
df_AbuDhabiCircuit.write.format("delta").mode("overwrite").save(
